...
function InvestForm(props) {
  ...
  const inputChangeHandler = (input,value) => {
    ...
    return (
        <form onSubmit={submitHandler} className={classes.investform}>
        <div className={classes['investinput-group']}>
          <p>
        ...
        <p className={classes.investactions}>
          <button type="reset" className={classes.investbuttonAlt} onClick={resetHandler}>
            Reset
          </button>
          <button type="submit" className={classes.investbutton}>
            Calculate
          </button>
        </p>
      </form>
